...
namespace MvcKutuphane.Models.Entity
{
    ...
    public partial class DbKutuphaneEntities2 : DbContext
    {
        ...
        public virtual ObjectResult<EnAktifKullanıcı_Result> EnAktifKullanıcı()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<EnAktifKullanıcı_Result>("EnAktifKullanıcı");
        }
    }
}
